...
module.exports = '<img class="feed-image light-shadow" src="./images/feed/liverick.jpg" />\n' +
    '<img class="feed-image light-shadow" src="./images/feed/cave.png" />\n' +
    '<img class="feed-image light-shadow" src="./images/feed/bryce2.jpg" />\n' +
    '<img class="feed-image light-shadow" src="./images/feed/joe2.jpg" />\n' +
    ...
    '<blockquote class="light-shadow feed-image instagram-media" data-instgrm-captioned data-instgrm-version="6" style=" background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:658px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);"><div style="padding:8px;"> <div style=" background:#F8F8F8; line-height:0; margin-top:40px; padding:50.0% 0; text-align:center; width:100%;"> <div style=" background:url(data:image/png;base64,); display:block; height:44px; margin:0 auto -44px; position:relative; top:-22px; width:44px;"></div></div> <p style=" margin:8px 0 0 0; padding:0 4px;"> <a href="https://www.instagram.com/p/BDEl_UKELA0/" style=" color:#000; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px; text-decoration:none; word-wrap:break-word;" target="_blank">Holy Fuck........ what a south by... #sxsw #burgerrecords #wienermania #wienerrecords 📷 by @burgerrecords4life</a></p> <p style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; line-height:17px; margin-bottom:0; margin-top:8px; overflow:hidden; padding:8px 0 7px; text-align:center; text-overflow:ellipsis; white-space:nowrap;">A photo posted by ICE CREAM THE BAND (@thebandicecream) on <time style=" font-family:Arial,sans-serif; font-size:14px; line-height:17px;" datetime="2016-03-17T22:59:21+00:00">Mar 17, 2016 at 3:59pm PDT</time></p></div></blockquote>\n' +
    '<img class="feed-image light-shadow" src="./images/feed/hockeydad.jpg" />\n' +
    '<img class="feed-image light-shadow" src="./images/feed/profile1.jpg" />\n' +
...
module.exports = '<div class="outlined light-shadow press-container">\n' +
    ...
    '	<p>\n' +
    '		<a href="http://www.thewildhoneypie.com/san-franciscos-ice-cream-premieres-newest-track-seventeen-stream/">-The Wild Honey Bee </a>\n' +
    '	</p>\n' +
    '</div>\n' +
    '<div class="outlined light-shadow press-container">\n' +
    '	<div class="press-header">\n' +
